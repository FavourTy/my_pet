              ...
              child: ListView(
                ...
                children: [
                  ...
                  PostCard(
                    ...
                    hasImages: true,
                    onMoreTap: () => _showDeleteDialog(context),
                  ),
                  PostCard(
                    name: "xxxx",
                    time: "2027/10/01 (Mon) 12:09",
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    "Permanently remove from the bulletin board.",
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    "This page has not yet been posted\nWould you like to save your comment?",
                    textAlign: TextAlign.center,
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                  ),
                  const SizedBox(height: 20),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildBtn(
                          "save",
                          true,
                          () => _showSavedCommentDialog(context),
                        ),
                      ),
                    ],
                  ),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    "There is a comment you saved last time\nWould you like to meet again with this content?",
                    textAlign: TextAlign.center,
