              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: const CircleAvatar(backgroundColor: Colors.white24, child: Icon(Icons.close, color: Colors.white)),
                  ),
                  Container(
                    width: 40, height: 5, 
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                       image: NetworkImage("https://via.placeholder.com/300x400"), // Replace with your pet image
                       fit: BoxFit.cover
                    )
                  ),
                  child: Stack(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Text("XX-chan", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.grey)),
                        Expanded(
                          child: Align(
                            ...
                            child: Container(
                              ...
                              child: const Text("SHOP", style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold)),
                            ),
                          ),
                        )
                      ],
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (index == 2) {
                           return GestureDetector(
                             onTap: () => setState(() => _stamps.add(Offset.zero)),
                             child: Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          // The Stamp Image
          const Center(child: Icon(Icons.favorite, color: Colors.red, size: 60)),
